    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">
                TunnelForge
              </h1>
            </div>
            <div className="flex items-center space-x-4">
              <a
                href="https://github.com/yourusername/tunnelforge"
                target="_blank"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white shadow-xl rounded-xl overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-5">
            ...
            <p className="text-blue-100 mt-1">
              Manage and monitor your secure tunnels
            </p>
          </div>
          <div className="p-6">
            <TunnelList />
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          <p>
            TunnelForge © {new Date().getFullYear()} - Secure tunneling made
            simple
          </p>
        </div>
      </main>
